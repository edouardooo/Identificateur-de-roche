...
def main():
    ...
    st.image("https://raw.githubusercontent.com/edouardooo/Identificateur-de-roche/d7bcde8e3d60914e9f2810f21d3688ed910e2b87/"+"%20".join(result)+".jpg", use_column_width=True)
